...
namespace S_DES
{
	public partial class Form1 : Form
	{
		...
		{
			InitializeComponent();
			textBoxEncodeKeyWord.Text = textBox3.Text;
			textBoxDecodeKeyWord.Text = textBox4.Text;

		}
		TextBox textBoxEncodeKeyWord = new TextBox();
		TextBox textBoxDecodeKeyWord = new TextBox();
		...
		private void button2_Click(object sender, EventArgs e)
		{
			...
			if (textBoxEncodeKeyWord.Text.Length > 0)
			{
				...
				if (buf > 0)
					result = result.Remove(result.Length - buf, buf);
